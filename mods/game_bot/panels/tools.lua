...
Panels.TradeMessage = function(parent)
  ...
  context.addTextEdit("autoTradeMessage", context.storage.autoTradeMessage or "I'm using OTClient Shattered Realms - https://github.com/mehah/otclient", function(widget, text)
