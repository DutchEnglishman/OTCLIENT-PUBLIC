GameServerOpcodes = {
    ...
    GameServerChangeMapAwareRange           = 42 , -- 0x2A
    GameServerPartyAnalyzer                 = 43 , -- 0x2B
    GameServerSpecialContainer              = 44 , -- 0x2C
    GameServerTeamFinderTeamLeader          = 45 , -- 0x2D | Unused
    GameServerTeamFinderTeamMember          = 46 , -- 0x2E | Unused
...
ClientOpcodes = {
    ...
    ClientChangeMapAwareRange               = 42 , -- 0x2A
